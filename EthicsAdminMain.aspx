<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EthicsAdminMain.aspx.cs" Inherits="EthicsAdminMain" %>
...
<body>
    <form id="frmEOMain" runat="server">
    <div id="MainDiv">
